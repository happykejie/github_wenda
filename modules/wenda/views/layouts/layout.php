...
<body>
    ...
    <nav id="nav" class="mui-bar footer mui-bar-tab" style="bottom:0px;z-index:9999;border:none;">
        <a id="defaultTab" class="mui-tab-item mui-active">问答</a>
        <a id="defaultTab2" class="mui-tab-item">找人</a>
